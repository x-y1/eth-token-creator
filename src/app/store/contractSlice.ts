 ...
 */
contract ${constructor.tokenName}Token is ERC20`;
    ...
    /**
     * @dev Enter your token name, supply, and symbol.
     */
    constructor() payable ERC20("${constructor.tokenName}", "${constructor.symbol}") {
